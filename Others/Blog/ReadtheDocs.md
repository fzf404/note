...
> [Read the Docs](https://links.jianshu.com/go?to=https%3A%2F%2Freadthedocs.org%2F)是一个在线文档托管服务。

## Sphinx

> 基于Python的文档生成项目，可使用markdown。
...
> 在根目录执行`make html`，进入`build/html`目录后用浏览器打开`index.html`
>
> toctree 支持多级目录：
