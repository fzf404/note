...
- 前端三件套
  ...
  > [我的官网](https://www.fzf404.top/)

  <iframe src="https://www.fzf404.top/" width="80%" height="500px"></iframe>

- Bootstrap + Jquery

  ![](https://gitee.com/nmdfzf404/Image-hosting/raw/master/2021/20210410204945.png)
...
- Vue3 + Vite + NaiveUI
  ...
  <iframe src="https://favor.fzf404.top/" width="80%" height="500px"></iframe>
...
- Node + Express
  ...
  > [template](https://github.com/fzf404/ExpressTemp)

- Node + Nestjs + TypeScript

  > [template](https://github.com/fzf404/nest-template)
...
- Python + Django
  ...
  > [template](https://github.com/fzf404/DjangoTemp)

- WebHooks

  > [WebHooks](https://github.com/fzf404/GoWebHooks)

- Go + gRPC + Zero

  > [gRPC-Demo](https://github.com/fzf404/go-grpc-demo)
  >
