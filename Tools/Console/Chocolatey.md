...
# auto
choco install git github-desktop vscode nodejs-lts firefox chrome everything potplayer rufus freedownloadmanager obsidian docker-desktop vmwareworkstation gcc ccleaner steam-client -y
```
